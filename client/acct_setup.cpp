...
void LOOKUP_LOGIN_TOKEN_OP::handle_reply(int http_op_retval) {
    ...
    if (pli->is_account_manager) {
        ...
        gstate.acct_mgr_info.project_name = pli->name;
        gstate.acct_mgr_info.master_url = pli->master_url;
        gstate.acct_mgr_info.user_name = user_name;
        gstate.acct_mgr_info.authenticator = authenticator;
